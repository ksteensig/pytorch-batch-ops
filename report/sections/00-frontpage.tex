...
\vspace*{\fill}
  ...
  {\color{white}\fboxsep0pt\colorbox{aaublue}{\begin{tabular}{@{}p{\textwidth}@{}}
    \begin{center}
    \Huge{\textbf{
      GPU Accelerated Compressed Singular Value Decomposition% insert your title here
    }}
    \end{center}
    \begin{center}
      \Large{
        With Applications in Deep Learning% insert your subtitle here
      }
    \end{center}
    \vspace{0.2cm}
   \begin{center}
    {\Large
      Kasper Steensig Jensen% insert names separated by comma
    }\\
    \vspace{0.2cm}
    {\large
      Signal Processing \& Acoustics, 20gr871, Spring \the\year% insert name of study, group number, year-month
    }
   \end{center}
   \vspace{0.2cm}
